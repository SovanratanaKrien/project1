          ...
          <ul>
            ...
            @guest
                @if (Route::has('register'))
                    <li>
                        <a href="{{ route('register') }}"><span class='bi bi-person-plus-fill'><strong>{{ __(' New User Register') }}</strong></span></a>
                    </li>
                @endif
                @if (Route::has('login'))
                    <button class="btn btn-default" type="button" data-bs-toggle="offcanvas" data-bs-target="#demo"><strong>{{ __('LOGIN') }}</strong></button>
                    <div class="offcanvas offcanvas-end" id="demo">
                        <div class="offcanvas-header" style="background-color: #f8f6f5;">
                            <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
                        </div>
                        <div class="offcanvas-body">
                            <div class="offcanvas-title text-md-center">
                                <h2>{{ __('LOG-IN') }}</h2>
                            </div>
